...
[![Latest Release](https://img.shields.io/github/v/release/REPLACE_WITH_YOUR_GITHUB_USERNAME/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO?label=latest&color=2f8ef4&style=for-the-badge)](https://github.com/REPLACE_WITH_YOUR_GITHUB_USERNAME/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/REPLACE_WITH_YOUR_GITHUB_USERNAME/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/total?color=6fc3ff&style=for-the-badge)](https://github.com/REPLACE_WITH_YOUR_GITHUB_USERNAME/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/releases)
...
<a href="https://REPLACE_WITH_YOUR_GITHUB_USERNAME.github.io/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/"><b>Website</b></a> ·
...
Grab the latest installer from **[Releases](https://github.com/REPLACE_WITH_YOUR_GITHUB_USERNAME/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/releases/latest)**:
...
One license, activated on one machine. See the **[pricing page](https://REPLACE_WITH_YOUR_GITHUB_USERNAME.github.io/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/#pricing)** for current terms, discounts on longer billing cycles, and tax details.
...
Found a bug, or something not working as expected? Open an **[issue](https://github.com/REPLACE_WITH_YOUR_GITHUB_USERNAME/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/issues)** here.

For licensing or billing questions, use the contact link on the **[website](https://REPLACE_WITH_YOUR_GITHUB_USERNAME.github.io/REPLACE_WITH_YOUR_PUBLIC_RELEASES_REPO/)**, or email **REPLACE_WITH_YOUR_SUPPORT_EMAIL**.
